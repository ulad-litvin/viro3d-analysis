'''
Script to calculate the last common ancestor (LCA) for each cluster based on ICTV taxonomy
...
# Load ICTV taxonomy
file = "~/1_dataset_preparation/msl38v2/VMR_MSL38_v2.xlsx"
...
for index, row in df_rep.iterrows():
    ...
    taxalist = df_mem_sup['ictv_species'].tolist()
